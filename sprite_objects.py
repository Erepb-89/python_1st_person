...
class Sprites:
    def __init__(self):
        self.sprite_types = {
            'barrel': pygame.image.load('sprites/barrel/base/0.png').convert_alpha(),
            'pedestal': pygame.image.load('sprites/pedestal/base/0.png').convert_alpha(),
            'devil': [pygame.image.load(f'sprites/devil/base/{i}.png') for i in range(8)],
        }
