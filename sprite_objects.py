    ...
    def __init__(self):
        self.sprite_parameters = {
            'sprite_barrel': {
                ...
                'scale': 0.4,
                'animation': deque(
                    [pygame.image.load(f'sprites/barrel/anim/{i}.png')
            ...
            'sprite_pedestal': {
                'sprite': pygame.image.load('sprites/pedestal/base/0.png'),
                'viewing_angles': None,
                'shift': 1.1,
                'scale': 0.5,
                'animation': None,
            ...
            'sprite_pin': {
                'sprite': pygame.image.load('sprites/pin/base/0.png'),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': 0.2,
                'animation': deque(
                    [pygame.image.load(f'sprites/pin/anim/{i}.png')
            ...
            'sprite_devil': {
                'sprite': [pygame.image.load(f'sprites/devil/base/{i}.png')
                               .convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': -0.2,
                'scale': 1.1,
                'animation': deque(
                    [pygame.image.load(f'sprites/devil/anim/{i}.png')
            ...
            'sprite_flame': {
                'sprite': pygame.image.load('sprites/flame/base/0.png'),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': 0.6,
                'animation': deque(
                    [pygame.image.load(f'sprites/flame/anim/{i}.png')
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters['sprite_pedestal'], (9.8, 3.2)),
            SpriteObject(self.sprite_parameters['sprite_pedestal'], (9.8, 4.8)),
...
class SpriteObject:
    ...
    def object_locate(self, player):
        ...
        if 0 <= fake_ray <= FAKE_RAYS_RANGE and distance_to_sprite > 50:
